...
namespace MagicStore.Migrations
{
    ...
    public partial class PopularCards : Migration
    {
        ...
        {
            migrationBuilder.Sql("INSERT INTO Cards(CategoryId, CardName, CardType, CardColor, CardShortDescripton, CardLongDescription, CardPrice, CardImageUrl, CardImageThumbnailUrl, CardFavorite, CardSoldOut) "+
