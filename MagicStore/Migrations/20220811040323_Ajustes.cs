        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CartaTipo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CartaCor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    IsCartaPreferida = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarrinhoCompraItens_Cartas_CartaId",
                        column: x => x.CartaId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PedidoDetalhes_Cartas_CartaId",
                        column: x => x.CartaId,
                        principalTable: "Cartas",
                        principalColumn: "CartaId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarrinhoCompraItens_CartaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PedidoDetalhes_CartaId",
